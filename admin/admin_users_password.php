...
function getPasswordChange($conn, $offset = 0, $perPage = 10) {
    $query = "SELECT p.*, u.fullname 
              FROM user_password_history p
        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    <div>
                        <h1 class="card-title">Users Password Changes/Reset Logs</h1>
...
<thead>
  <tr>
    ...
    <th>Timestamp</th>
                    ...
                    <tbody>
<?php 
    $otpHistory = getPasswordChange($conn, $offset, $perPage);
    if ($otpHistory) {
