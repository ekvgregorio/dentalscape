<?php
session_start();
if (!isset($_SESSION['admin_login_verification'])) {
...
<body>
    <div class="container">
        ...
        <?php endif; ?>
        <form method="POST" action="/dentalscape/admin/admin_login_process.php">
            <div class="otp-group">
            ...
            <button type="submit" name="verify_admin_otp"  class="verify-btn">Verify</button>
        </form>
    </div>
