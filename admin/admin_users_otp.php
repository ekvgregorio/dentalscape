        ...
        <div class="card">
            <div class="card-body">
                <div class="d-flex justify-content-between align-items-center mb-3">
                    <div>
                        <h1 class="card-title">Users OTP (One-Time Password) Usage</h1>
...
<thead>
  <tr>
    ...
    <th>Timestamp</th>
                    ...
                    <tbody>
<?php 
    $otpHistory = getOTPHistory($conn, $offset, $perPage);
    if ($otpHistory) {
            ...
            <tr>
                ...
                <td>
                  <span class="status-badge 
                      ...
                      text-white"
                      style="font-size: <?php 
                          if ($type === 'password_reset') echo '7px'; 
                          elseif ($type === 'email_change') echo '8px'; 
                          else echo '10px'; 
                      ?>;">
                      <?php 
                          if ($type === 'password_reset') echo 'Password Reset';
                          elseif ($type === 'email_change') echo 'Email Change';
                          else echo htmlspecialchars(ucfirst($type)); 
                      ?>
                  </span>
                </td>
                <td><?php echo date('M d, Y H:i', strtotime($record['otp_expiry'])); ?></td>
                <td>
                    <span class="status-badge <?php echo ($record['is_used'] == 1) ? 'bg-success' : 'bg-danger'; ?> text-white">
