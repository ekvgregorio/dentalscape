<?php 
  ...
  $totalAppointments = countHistoryAppointments($conn, $month_range, 'Pending');
            ...
            <div class="col-md-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        ...
                        <div>
                        <h5> </h5>
                        <h1 class="card-title">Appointment History</h1>
                    </div>
                    <div class="dropdown">
              ...
              <div class="table-responsive" style="max-height: 500px; overflow-y: auto;">
                <table id="appointmentTable" class="display expandable-table" style="width:100%">
                    <thead>
                        ...
                        <tbody>
                            <?php
                                $appointments = historyAppointments($conn, $month_range, ['Canceled', 'Done'], $offset, $perPage);
                                if ($appointments) {
                                  while ($record = $appointments->fetch_assoc()): ?>
                                    <tr style="cursor: pointer;" onmouseover="this.style.backgroundColor='#e6e6e6';" onmouseout="this.style.backgroundColor='';">
                                      ...
                                      <td>
                                        <span class="status-badge <?php echo ($record['status'] == 'Done') ? 'bg-success' : 'bg-danger'; ?> text-white">
