...
<head>
  ...
  <title>MotoSafe – Instructor Portal</title>
...
<body>
  ...
  <nav id="mainNav">
    ...
    <div class="nav-actions">
      <a href="instructor_portal.php" class="nbtn nbtn-primary active">
  ...
  <div class="mobile-menu" id="mobileMenu">
    ...
    <div class="m-actions">
      ...
      <a href="instructor_portal.php" class="nbtn nbtn-primary"><i class="fas fa-chalkboard-teacher"></i> Instructor Portal</a>
    </div>
  </div>
    ...
    <div class="auth-card">
      ...
      <div class="card-inner">
        ...
        <div style="display:flex; gap:10px; margin-bottom:18px; justify-content:center; flex-wrap:wrap;">
                      <a href="../student/student_portal.php" class="auth-tab on" style="text-decoration:none;">
            <i class="fas fa-chalkboard-teacher" style="font-size:12px;margin-right:5px;"></i> Student Login
          </a>
          
        </div>

        <div class="portal-pill"><div class="pill-dot"></div> Instructor Portal</div>

        <!---- Sign in Form ---->
        <div class="auth-form on" id="form-in">
          <div class="falert" id="alert-in"></div>
          <form method="POST" action="instructor_account_process.php">
            <div class="fg">
              <label class="flabel" for="si-email">Email Address</label>
              <div class="fwrap">
                <i class="fas fa-envelope fico"></i>
                <input class="finput" type="email" id="si-email" name="email" placeholder="instructor@example.com" autocomplete="email" required>
              </div>
            </div>
            ...
            <button type="submit" class="submit-btn" name="instructor_login">
