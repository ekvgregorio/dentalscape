...
<head>
<meta charset="UTF-8">
<title>Instructor Access Denied – MotoSafe</title>
...
<a href="instructor_portal.php" class="logo">
<div class="logo-mark">
...
<div class="card-sub">
You must be logged in to access the Instructor Dashboard.<br>
This area is restricted to authorized instructors only.
</div>
...
<a href="instructor_portal.php" class="btn-login">
